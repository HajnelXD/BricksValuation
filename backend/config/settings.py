...
SECRET_KEY = 'django-insecure-n^_))3_^8+y#3=c8^czt#i2mo5_op5f9s5obw@uny2r8s8nf&h'
...
ALLOWED_HOSTS = tuple(_allowed_hosts.split(',')) if _allowed_hosts else ()
...
DATABASES = {  # noqa: WPS407
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "bricks_valuation"),  # noqa: WPS226
